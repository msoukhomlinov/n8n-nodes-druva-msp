...
export const reportUsageOperations: INodeProperties[] = [
  {
    ...
    options: [
      ...
      },
      {
        ...
        description:
          "Retrieve detailed daily quota allocation and usage by tenant",
      },
      {
        name: "Get MSP Commit and Balance Report",
        value: "getCommitAndBalance",
        action: "Get MSP commit and balance report",
        description:
          "Retrieve detailed report on consumption units commitment, consumption, and balance",
      },
      {
        name: "Get Customer and License Daily Report",
        value: "getLicenseDailyReport",
        action: "Get customer and license daily report",
        description:
          "Retrieve daily data on licenses, add-ons, and feature details for all customers (last 60 days)",
      },
      {
        name: "Get Customer and License Monthly Report",
        value: "getLicenseMonthlyReport",
        action: "Get customer and license monthly report",
        description:
          "Retrieve monthly report detailing license, feature, and add-on information for all customers (last 18 months)",
      },
      {
        name: "Get Chargeback Tenant Consumption Daily Report",
        value: "getChargebackTenantConsumptionReport",
        action: "Get chargeback tenant consumption daily report",
        description:
          "Retrieve daily insights into customer product modules and consumption patterns",
      },
      {
        name: "Get Chargeback Tenant Consumption Monthly Report",
        value: "getChargebackTenantConsumptionMonthlyReport",
        action: "Get chargeback tenant consumption monthly report",
        description:
          "Retrieve monthly overview of customer product modules and usage trends",
      },
    ],
...
export const reportUsageFields: INodeProperties[] = [
  ...
  },
  {
    ...
    options: [
      {
        name: "Accelerated Ransomware Recovery",
        value: "Accelerated Ransomware Recovery",
      },
      ...
      {
        name: "Long Term Retention Storage",
        value: "Long Term Retention Storage",
      },
      { name: "Preserved Users", value: "Preserved Users" },
      {
        name: "Security Posture & Observability",
        value: "Security Posture & Observability",
      },
      {
        name: DRUVA_PRODUCT_NAMES.SENSITIVE_DATA_GOVERNANCE,
        value: DRUVA_PRODUCT_NAMES.SENSITIVE_DATA_GOVERNANCE,
      },
