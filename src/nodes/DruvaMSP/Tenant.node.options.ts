...
import { DRUVA_TENANT_FEATURE_NAMES } from "./helpers/Constants";
...
export const tenantFields: INodeProperties[] = [
...

  {
    ...
    description:
      "Whether to include tenant features in the response. Recommended: enabled, as features are required to identify Druva Provisioned tenants (servicePlanID = -1).",
  },
...

  {
    ...
    default: false,
    description: "Whether to filter results by product",
  },
  {
    displayName: "Product",
    name: "productFilter",
    ...
    default: "",
    description: "Product to filter tenants by",
  },
  ...
  },
  {
    ...
    default: "",
    description:
      "The product ID: 1 for Enterprise Workloads, 2 for SaaS Apps and Endpoints",
  },
  {
  ...
  },
  {
    ...
    default: "",
    description:
      "The date on which the tenant license will expire (format: YYYY-MM-DDTHH:MM:SSZ)",
  },
  {
  ...
  },
  {
    ...
    default: "",
    description:
      "The end date on which the quota limit will expire (format: YYYY-MM-DDTHH:MM:SSZ)",
  },
  {
        ...
        values: [
          {
            ...
            options: [
              {
                name: DRUVA_TENANT_FEATURE_NAMES.ENTERPRISE_WORKLOADS,
                value: DRUVA_TENANT_FEATURE_NAMES.ENTERPRISE_WORKLOADS,
              },
              {
                name: DRUVA_TENANT_FEATURE_NAMES.ENTERPRISE_WORKLOADS_ARR,
                value: DRUVA_TENANT_FEATURE_NAMES.ENTERPRISE_WORKLOADS_ARR,
              },
              {
                name: DRUVA_TENANT_FEATURE_NAMES.LONG_TERM_RETENTION,
                value: DRUVA_TENANT_FEATURE_NAMES.LONG_TERM_RETENTION,
              },
              {
                name: DRUVA_TENANT_FEATURE_NAMES.M365,
                value: DRUVA_TENANT_FEATURE_NAMES.M365,
              },
              {
                name: DRUVA_TENANT_FEATURE_NAMES.GOOGLE_WORKSPACE,
                value: DRUVA_TENANT_FEATURE_NAMES.GOOGLE_WORKSPACE,
              },
              {
                name: DRUVA_TENANT_FEATURE_NAMES.ENDPOINTS,
                value: DRUVA_TENANT_FEATURE_NAMES.ENDPOINTS,
              },
              {
                name: DRUVA_TENANT_FEATURE_NAMES.M365_ARR,
                value: DRUVA_TENANT_FEATURE_NAMES.M365_ARR,
              },
              {
                name: DRUVA_TENANT_FEATURE_NAMES.ENDPOINTS_ARR,
                value: DRUVA_TENANT_FEATURE_NAMES.ENDPOINTS_ARR,
              },
              {
                name: DRUVA_TENANT_FEATURE_NAMES.GOOGLE_WORKSPACE_ARR,
                value: DRUVA_TENANT_FEATURE_NAMES.GOOGLE_WORKSPACE_ARR,
              },
            ],
            description:
          ...
          },
          {
            ...
            default: {},
            description:
              "Attributes for the feature (e.g., userCount, preservedUserCount)",
            options: [
              {
                ...
                values: [
                  {
                    ...
                    options: [
                      ...
                      {
                        name: "preservedUserCount",
                        value: "preservedUserCount",
                      },
                      {
                        name: "educationLicenseState",
                        value: "educationLicenseState",
                      },
                    ],
                    default: "userCount",
                    description:
  ...
  },
  {
    ...
    default: {},
    description:
      "Updated list of features that need to be enabled or disabled for the tenant",
    options: [
      {
        displayName: "Feature",
        name: "feature",
        values: [
          ...
          },
          {
            ...
            default: true,
            description:
              "Whether this feature should be enabled (required by API).",
          },
          {
            displayName: "Attributes",
            name: "attrs",
